...
class ReasonMasterExportt implements FromCollection, WithHeadings, WithStyles, WithCustomStartCell, WithEvents
{
    /**
    ...
    public function collection()
    {
        ...
        $data = $reasonMasters->map(function ($reasonMaster, $index){
            return[
                ...
                'Activity' => $reasonMaster->activityName ? $rmv->activityName->activity_name : '---',
